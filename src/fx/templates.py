"""
Starter project templates for ``fx``.
...
name = "__DIST_NAME__"
version = "0.1.0"
description = "Todo CLI app structured by fx"
readme = "README.md"
...
name = "__DIST_NAME__"
version = "0.1.0"
description = "FastAPI + user management structured by fx"
readme = "README.md"
requires-python = ">=3.10"
dependencies = [
    "registers>=4.4.0",
...
Todo CLI starter project structured by `fx`.
...
FastAPI + user management starter project structured by `fx`.
...
OPS_CRON_WORKFLOW_TEMPLATE = """# Managed by fx
...
OPS_WINDOWS_WORKFLOW_TEMPLATE = """<Task>
  <Name>registers-ops-heartbeat</Name>
  <Trigger>*/30 * * * *</Trigger>
  <Action>
    <Command>python</Command>
    <Arguments>-m fx.commands cron trigger ops-heartbeat .</Arguments>
  </Action>
</Task>
"""
